...
2. [method] 基础设施升级时，先做兼容层再迁移，能显著降低切换风险
3. [insight] 多主题系统里，主题不仅要会渲染，还要能表达自己适合什么内容
4. [method] 主题推荐只有接到渲染和发布链路里，才不容易沦为展示功能
5. [method] 想让主题系统可扩展、可推荐、可演进，theme pack 应该拆成五层文件
